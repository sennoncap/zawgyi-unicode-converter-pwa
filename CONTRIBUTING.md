...
We use [Github issues](https://github.com/myanmartools/zawgyi-unicode-converter/issues) to track public bugs. Please ensure your description is clear and has sufficient instructions to be able to reproduce the issue.
...
1. Search [GitHub](https://github.com/myanmartools/zawgyi-unicode-converter/pulls) for an open or closed PR that relates to your submission. You don't want to duplicate effort.

2. [Fork](https://help.github.com/articles/fork-a-repo/) the [repo](https://github.com/myanmartools/zawgyi-unicode-converter) and create your branch `topic` from master.
...
8. In GitHub, submit a [pull request](https://help.github.com/articles/about-pull-requests) to [myanmartools/zawgyi-unicode-converter](https://github.com/myanmartools/zawgyi-unicode-converter).
